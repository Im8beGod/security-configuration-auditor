...
import { listKnowledgePacks, listKnowledgePackVersions, listUnresolved, trainingKeys } from '../../shared/api/training'
...
export function TrainingPage() {
  ...
  return <section className="page-stack training-page">
    <header className="page-heading"><div><span className="eyebrow">Administrator-supervised learning</span><h1>Review Center</h1><p>Turn unresolved syntax into bounded canonical mappings. Deterministic validation and human approval remain mandatory.</p></div><span className="trust-chip">AI advisory only</span></header>
