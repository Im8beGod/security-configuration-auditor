...
REMEDIATION_PREVIEW_REVISION = "20260922_0024"
RUNTIME_RULE_REVISION = "20260923_0025"
STAGE6_FRAMEWORK_REVISION = "20260923_0026"
RUNTIME_RULE_IMMUTABILITY_REVISION = "20260924_0027"
...
def test_migration_history_extends_parentless_baseline() -> None:
    ...
    assert script.get_heads() == [RUNTIME_RULE_IMMUTABILITY_REVISION]
    assert len(revisions) == 27
    expected = [RUNTIME_RULE_IMMUTABILITY_REVISION, STAGE6_FRAMEWORK_REVISION, RUNTIME_RULE_REVISION, REMEDIATION_PREVIEW_REVISION, MULTIFRAMEWORK_REVISION, ARISTA_EOS_REVISION, PHASE1_REMEDIATION_FIX_REVISION, H2_WORKER_LEASE_REVISION, H1_SCHEMA_DRIFT_REVISION, B10_REMEDIATION_REVISION, ISO_ALIGNMENT_REVISION, CIS_PACK_REVISION, DISA_PACK_REVISION, NIST_PACK_REVISION, PROFILE_MANIFEST_REVISION, ASSESSMENT_PACK_REVISION, STEP_11_1_REVISION, STEP_10A_REVISION, STEP_9_2_REVISION, STEP_9_1_REVISION, STEP_7_1_REVISION, STEP_6A_REVISION, STEP_5C_REVISION, STEP_3_9_REVISION, STEP_3_6_REVISION, CURRENT_REVISION, BASELINE_REVISION]
    assert [item.revision for item in revisions] == expected
    assert revisions[0].down_revision == STAGE6_FRAMEWORK_REVISION
...
def test_canonical_metadata_has_identity_tables_and_naming_convention() -> None:
    assert set(Base.metadata.tables) == {
        ...
        "assessment_pack_versions", "assessment_obligations", "audit_assessments", "audit_framework_assessments", "assessment_results", "profile_manifest_versions", "profile_resolution_decisions", "runtime_rule_versions"
    }
