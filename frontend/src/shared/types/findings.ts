...
export interface Remediation { status: string; reason: string | null; finding_id: string; procedure_id?: string; procedure_key?: string; procedure_version?: number; title?: string; security_objective?: string; description?: string; safety_warnings?: string[]; prerequisites?: Array<{ text?: string }>; required_parameters?: Array<{ name: string; label?: string; type: string; required?: boolean; values?: string[] }>; ordered_steps?: Array<{ text: string }>; verification_steps?: Array<{ text: string }>; rollback_steps?: Array<{ text: string }>; source_references?: Array<{ title?: string }>; selection_source?: string; rendered_steps?: string[]; rendered_verification_steps?: string[]; rendered_rollback_steps?: string[] }
