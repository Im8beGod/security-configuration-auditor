...
REMEDIATION_PROCEDURE_REGISTRY = RemediationProcedureRegistry(
    REVIEWED_CISCO_PROCEDURES + REVIEWED_MULTI_VENDOR_PROCEDURES + REVIEWED_ARISTA_PROCEDURES
)
REVIEWED_CISCO_PROCEDURES_BY_RULE = MappingProxyType({
    item.rule_id: item for item in REVIEWED_CISCO_PROCEDURES + REVIEWED_MULTI_VENDOR_PROCEDURES
