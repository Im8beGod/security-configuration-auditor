...
REVIEWED_STAGE7_EXPANSION_PROCEDURES = (
    ReviewedProcedure(
        procedure_id=UUID("20000000-0000-0000-0000-000000000002"),
        procedure_key="cisco.vty-idle-timeout", version=1,
        rule_id="management.idle_timeout.maximum", title="Configure Cisco IOS XE VTY idle timeout",
        security_objective="Terminate inactive VTY sessions within the approved interval.",
        description="Preview the bounded VTY timeout change for the selected range.",
        status=RemediationProcedureStatus.PUBLISHED, profile_applicability={"profile_version_ids": [CISCO_PROFILE]},
        prerequisites=[{"text": "Confirm the organization-approved timeout and retain alternate administrative access."}],
        safety_warnings=[_COMMON_WARNING, "A zero timeout is intentionally not offered."],
        required_parameters=[{"name": "vty_range", "label": "VTY range", "type": "enum", "values": ["0 4", "5 15", "0 15"], "required": True}, {"name": "minutes", "label": "Idle timeout minutes", "type": "integer", "minimum": 1, "maximum": 60, "required": True}],
        configuration_context=["global configuration mode", "line VTY configuration mode"],
        ordered_steps=[{"text": "configure terminal"}, {"text": "line vty {vty_range}"}, {"text": "exec-timeout {minutes} 0"}, {"text": "end"}],
        verification_steps=[{"text": "show running-config | section line vty"}],
        rollback_steps=[{"text": "Restore the captured prior exec-timeout for the selected VTY range through approved change control."}],
        validation_results=[{"review": "passed", "scope": "Cisco IOS XE 17.x", "commands": ["line vty <range>", "exec-timeout <minutes> 0"]}],
        source_references=[{"title": "Cisco IOS XE 17 Line Commands", "url": "https://www.cisco.com/c/en/us/td/docs/routers/sdwan/configuration/command/cisco-sd-wan-qualified-command-reference-guide/line-commands.html"}],
        reviewed_at="2026-09-23", validated_at="2026-09-23",
    ),
    ReviewedProcedure(
        procedure_id=UUID("20000000-0000-0000-0000-000000000004"),
        procedure_key="fortios.admin-timeout", version=1,
        rule_id="management.idle_timeout.maximum", title="Configure FortiOS administrator idle timeout",
        security_objective="Terminate inactive FortiOS administrator sessions within the approved interval.",
        description="Preview the bounded global administrator timeout change.",
        status=RemediationProcedureStatus.PUBLISHED, profile_applicability={"profile_version_ids": [FORTIOS_PROFILE]},
        prerequisites=[{"text": "Confirm the organization-approved timeout and retain alternate administrative access."}],
        safety_warnings=[_COMMON_WARNING, "A zero timeout is intentionally not offered."],
        required_parameters=[{"name": "minutes", "label": "Idle timeout minutes", "type": "integer", "minimum": 1, "maximum": 480, "required": True}],
        configuration_context=["config system global"],
        ordered_steps=[{"text": "config system global"}, {"text": "set admintimeout {minutes}"}, {"text": "end"}],
        verification_steps=[{"text": "show system global | grep admintimeout"}],
        rollback_steps=[{"text": "Restore the captured prior admintimeout through approved change control."}],
        validation_results=[{"review": "passed", "scope": "FortiOS 7.x", "commands": ["set admintimeout <minutes>"]}],
        source_references=[{"title": "FortiOS 7 CLI Reference", "url": "https://docs.fortinet.com/document/fortigate/7.0.0/cli-reference"}],
        reviewed_at="2026-09-23", validated_at="2026-09-23",
    ),
    ReviewedProcedure(
        procedure_id=UUID("20000000-0000-0000-0000-000000000006"),
        procedure_key="junos.login-idle-timeout", version=1,
        rule_id="management.idle_timeout.maximum", title="Configure Junos system login idle timeout",
        security_objective="Terminate inactive Junos administrative sessions within the approved interval.",
        description="Preview the bounded system login idle-timeout change.",
        status=RemediationProcedureStatus.PUBLISHED, profile_applicability={"profile_version_ids": [JUNOS_PROFILE]},
        prerequisites=[{"text": "Review login-class overrides and retain console or alternate administrative access."}],
        safety_warnings=[_COMMON_WARNING, "This system setting may be superseded by an explicitly configured login class."],
        required_parameters=[{"name": "minutes", "label": "Idle timeout minutes", "type": "integer", "minimum": 1, "maximum": 60, "required": True}],
        configuration_context=["Junos configuration mode"],
        ordered_steps=[{"text": "set system login idle-timeout {minutes}"}],
        verification_steps=[{"text": "show configuration system login | compare"}],
        rollback_steps=[{"text": "Restore the captured prior system login idle-timeout through approved change control."}],
        validation_results=[{"review": "passed", "scope": "Junos 18.x", "commands": ["set system login idle-timeout <minutes>"]}],
        source_references=[{"title": "Junos system services and idle-timeout", "url": "https://www.juniper.net/documentation/us/en/software/junos/cli-reference/topics/ref/statement/idle-timeout-edit-system-login.html"}],
        reviewed_at="2026-09-23", validated_at="2026-09-23",
    ),
    ReviewedProcedure(
        procedure_id=UUID("20000000-0000-0000-0000-000000000013"),
        procedure_key="fortios.7.disable-http-access", version=1,
        rule_id="management.http.disabled", title="Disable FortiOS HTTP management access",
        security_objective="Remove HTTP from the complete reviewed interface management protocol set.",
        description="Preview a complete reviewed allowaccess replacement that excludes HTTP.",
        status=RemediationProcedureStatus.PUBLISHED, profile_applicability={"profile_version_ids": [FORTIOS_PROFILE]},
        prerequisites=[{"text": "Capture the complete current allowaccess set and confirm SSH or HTTPS access."}],
        safety_warnings=[_COMMON_WARNING, "The command replaces the interface protocol set; omitted protocols are removed."],
        required_parameters=[{"name": "interface", "label": "Interface", "type": "hostname", "required": True}, {"name": "protocols", "label": "Approved protocols", "type": "enum", "values": ["https ssh", "https ping ssh", "ping ssh"], "required": True}],
        configuration_context=["config system interface"],
        ordered_steps=[{"text": "config system interface"}, {"text": "edit {interface}"}, {"text": "set allowaccess {protocols}"}, {"text": "next"}, {"text": "end"}],
        verification_steps=[{"text": "show system interface {interface}"}],
        rollback_steps=[{"text": "Restore the captured prior allowaccess protocol set for {interface}."}],
        validation_results=[{"review": "passed", "scope": "FortiOS 7.x", "commands": ["set allowaccess <approved protocols without http>"]}],
        source_references=[{"title": "FortiOS 7 CLI Reference", "url": "https://docs.fortinet.com/document/fortigate/7.0.0/cli-reference"}],
        reviewed_at="2026-09-23", validated_at="2026-09-23",
    ),
    ReviewedProcedure(
        procedure_id=UUID("20000000-0000-0000-0000-000000000014"),
        procedure_key="fortios.7.enable-https-access", version=1,
        rule_id="management.https.enabled", title="Enable FortiOS HTTPS management access",
        security_objective="Include HTTPS in the complete reviewed interface management protocol set.",
        description="Preview a complete reviewed allowaccess replacement that includes HTTPS.",
        status=RemediationProcedureStatus.PUBLISHED, profile_applicability={"profile_version_ids": [FORTIOS_PROFILE]},
        prerequisites=[{"text": "Capture the complete current allowaccess set and retain alternate administrative access."}],
        safety_warnings=[_COMMON_WARNING, "The command replaces the interface protocol set; omitted protocols are removed."],
        required_parameters=[{"name": "interface", "label": "Interface", "type": "hostname", "required": True}, {"name": "protocols", "label": "Approved protocols", "type": "enum", "values": ["https ssh", "https ping ssh"], "required": True}],
        configuration_context=["config system interface"],
        ordered_steps=[{"text": "config system interface"}, {"text": "edit {interface}"}, {"text": "set allowaccess {protocols}"}, {"text": "next"}, {"text": "end"}],
        verification_steps=[{"text": "show system interface {interface}"}],
        rollback_steps=[{"text": "Restore the captured prior allowaccess protocol set for {interface}."}],
        validation_results=[{"review": "passed", "scope": "FortiOS 7.x", "commands": ["set allowaccess <approved protocols with https>"]}],
        source_references=[{"title": "FortiOS 7 CLI Reference", "url": "https://docs.fortinet.com/document/fortigate/7.0.0/cli-reference"}],
        reviewed_at="2026-09-23", validated_at="2026-09-23",
    ),
    ReviewedProcedure(
        procedure_id=UUID("20000000-0000-0000-0000-000000000015"),
        procedure_key="fortios.7.tls-minimum-1-2", version=1,
        rule_id="management.tls.minimum_1_2", title="Configure FortiOS HTTPS TLS minimum 1.2",
        security_objective="Restrict the reviewed HTTPS TLS version set to TLS 1.2 and 1.3.",
        description="Preview the bounded global HTTPS TLS version set.",
        status=RemediationProcedureStatus.PUBLISHED, profile_applicability={"profile_version_ids": [FORTIOS_PROFILE]},
        prerequisites=[{"text": "Confirm all required management clients support TLS 1.2 or later."}],
        safety_warnings=[_COMMON_WARNING, "This replaces the complete configured HTTPS TLS version set."],
        required_parameters=[], configuration_context=["config system global"],
        ordered_steps=[{"text": "config system global"}, {"text": "set admin-https-ssl-versions tlsv1-2 tlsv1-3"}, {"text": "end"}],
        verification_steps=[{"text": "show system global | grep admin-https-ssl-versions"}],
        rollback_steps=[{"text": "Restore the captured prior admin-https-ssl-versions through approved change control."}],
        validation_results=[{"review": "passed", "scope": "FortiOS 7.x", "commands": ["set admin-https-ssl-versions tlsv1-2 tlsv1-3"]}],
        source_references=[{"title": "FortiOS 7 CLI Reference", "url": "https://docs.fortinet.com/document/fortigate/7.0.0/cli-reference"}],
        reviewed_at="2026-09-23", validated_at="2026-09-23",
    ),
    ReviewedProcedure(
        procedure_id=UUID("20000000-0000-0000-0000-000000000016"),
        procedure_key="fortios.7.enable-logging", version=1,
        rule_id="logging.enabled", title="Enable FortiOS configuration logging",
        security_objective="Enable the observed FortiOS logging setting.",
        description="Preview the bounded FortiOS logging-status enablement command.",
        status=RemediationProcedureStatus.PUBLISHED, profile_applicability={"profile_version_ids": [FORTIOS_PROFILE]},
        prerequisites=[{"text": "Confirm the applicable logging destination and retention policy."}],
        safety_warnings=[_COMMON_WARNING], required_parameters=[], configuration_context=["config log setting"],
        ordered_steps=[{"text": "config log setting"}, {"text": "set status enable"}, {"text": "end"}],
        verification_steps=[{"text": "show log setting"}],
        rollback_steps=[{"text": "Restore the captured prior logging status through approved change control."}],
        validation_results=[{"review": "passed", "scope": "FortiOS 7.x", "commands": ["set status enable"]}],
        source_references=[{"title": "FortiOS 7 CLI Reference", "url": "https://docs.fortinet.com/document/fortigate/7.0.0/cli-reference"}],
        reviewed_at="2026-09-23", validated_at="2026-09-23",
    ),
    ReviewedProcedure(
        procedure_id=UUID("20000000-0000-0000-0000-000000000017"),
        procedure_key="fortios.7.remote-logging-server", version=1,
        rule_id="logging.remote.destination.configured", title="Configure FortiOS remote logging server",
        security_objective="Set the reviewed FortiOS remote logging destination.",
        description="Preview the bounded FortiOS syslog server setting.",
        status=RemediationProcedureStatus.PUBLISHED, profile_applicability={"profile_version_ids": [FORTIOS_PROFILE]},
        prerequisites=[{"text": "Confirm the destination is approved and reachable by the device."}],
        safety_warnings=[_COMMON_WARNING], required_parameters=[{"name": "destination", "label": "Logging server", "type": "hostname", "required": True}],
        configuration_context=["config log syslogd setting"],
        ordered_steps=[{"text": "config log syslogd setting"}, {"text": "set server {destination}"}, {"text": "end"}],
        verification_steps=[{"text": "show log syslogd setting"}],
        rollback_steps=[{"text": "config log syslogd setting"}, {"text": "unset server"}, {"text": "end"}],
        validation_results=[{"review": "passed", "scope": "FortiOS 7.x", "commands": ["set server <destination>"]}],
        source_references=[{"title": "FortiOS 7 CLI Reference", "url": "https://docs.fortinet.com/document/fortigate/7.0.0/cli-reference"}],
        reviewed_at="2026-09-23", validated_at="2026-09-23",
    ),
)

UNAVAILABLE_REMEDIATION_REASONS = MappingProxyType({
    (CISCO_PROFILE, "management.source.restriction.configured"): "cisco_access_class_requires_acl_and_direction_review",
    (CISCO_PROFILE, "logging.enabled"): "cisco_logging_disable_not_semantically_modeled",
    (CISCO_PROFILE, "logging.remote.destination.approved"): "organization_approved_logging_destination_required",
    (CISCO_PROFILE, "time.ntp.configured"): "cisco_ntp_absence_is_missing_evidence",
    (CISCO_PROFILE, "time.ntp.authentication.enabled"): "cisco_ntp_authentication_absence_is_missing_evidence",
    (CISCO_PROFILE, "time.ntp.server.approved"): "organization_approved_ntp_server_required",
    (FORTIOS_PROFILE, "management.source.restriction.configured"): "fortios_trusthost_administrator_scope_requires_review",
    (FORTIOS_PROFILE, "logging.remote.destination.approved"): "organization_approved_logging_destination_required",
    (FORTIOS_PROFILE, "time.ntp.server.configured"): "fortios_ntp_server_slot_and_sync_policy_require_review",
    (FORTIOS_PROFILE, "time.ntp.configured"): "fortios_ntp_server_slot_and_sync_policy_require_review",
    (FORTIOS_PROFILE, "time.ntp.server.approved"): "organization_approved_ntp_server_required",
    (JUNOS_PROFILE, "logging.remote.destination.configured"): "junos_syslog_facility_and_severity_require_review",
    (JUNOS_PROFILE, "logging.remote.destination.approved"): "organization_approved_logging_destination_required",
    (JUNOS_PROFILE, "time.ntp.server.configured"): "junos_ntp_routing_instance_scope_requires_review",
    (JUNOS_PROFILE, "time.ntp.configured"): "junos_ntp_routing_instance_scope_requires_review",
    (JUNOS_PROFILE, "time.ntp.server.approved"): "organization_approved_ntp_server_required",
    (ARISTA_PROFILE, "management.source.restriction.configured"): "arista_management_acl_definition_and_attachment_require_review",
    (ARISTA_PROFILE, "logging.remote.destination.approved"): "organization_approved_logging_destination_required",
    (ARISTA_PROFILE, "time.ntp.server.approved"): "organization_approved_ntp_server_required",
})


def unavailable_remediation_reason(profile_version_id: str | None, rule_id: str) -> str | None:
    return UNAVAILABLE_REMEDIATION_REASONS.get((profile_version_id, rule_id))

REMEDIATION_PROCEDURE_REGISTRY = RemediationProcedureRegistry(
    REVIEWED_CISCO_PROCEDURES + REVIEWED_MULTI_VENDOR_PROCEDURES + REVIEWED_ARISTA_PROCEDURES + REVIEWED_STAGE7_PROCEDURES + REVIEWED_STAGE7_EXPANSION_PROCEDURES
)
