...
from app.jobs.handlers import handle_pdf_generation, handle_system_noop
...
PRODUCTION_HANDLERS: Mapping[JobType, JobHandler] = MappingProxyType(
    {JobType.SYSTEM_NOOP: handle_system_noop, JobType.PDF_GENERATION: handle_pdf_generation}
)
