...
import type { CanonicalField, ImpactAnalysis, KnowledgePack, KnowledgePackVersion, MappingDefinition, MappingVersion, Publication, ReviewStatus, UnresolvedBlock, ValidationRequest } from '../types/training'
...
export async function validateMapping(id: string): Promise<ValidationRequest> { return await apiRequest(`/training/mappings/${id}/validate`, { method: 'POST' }) as ValidationRequest }
