...
export function DevicesPage() {
  ...
  return <section className="page-stack">
    <header className="page-heading heading-actions"><div><span className="eyebrow">Asset inventory</span><h1>Devices</h1><p>Logical assets that organize evidence over time. No vendor or platform has been inferred.</p></div><button className="button-primary" onClick={() => setShowForm((value) => !value)}>{showForm ? 'Close form' : 'Create Device'}</button></header>
